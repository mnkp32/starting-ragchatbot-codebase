...
class TestSystemDiagnosis:
    ...
    def test_content_query_uses_search_tool(self):
        ...
        with patch('rag_system.DocumentProcessor'), \
            ...
            mock_ai_gen = Mock()
            mock_ai_gen.generate_response.return_value = "RAG is a technique that combines retrieval with generation..."
            ...
            assert response == "RAG is a technique that combines retrieval with generation..."
    ...
    def test_search_tool_with_real_vector_store_mock(self):
        ...
        mock_results = SearchResults(
            documents=["RAG stands for Retrieval-Augmented Generation. It combines retrieval with generation."],
            metadata=[{"course_title": "RAG Systems Course", "lesson_number": 1, "chunk_index": 0}],
            distances=[0.1]
        )
    ...
    def test_ai_generator_mock_tool_calling(self):
        ...
        with patch('ai_generator.anthropic.Anthropic') as mock_anthropic_class:
            ...
            mock_final_content.text = "RAG systems combine retrieval with generation for better AI responses."
            ...
            mock_tool_manager.execute_tool.return_value = "Search results about RAG systems..."
            ...
            assert response == "RAG systems combine retrieval with generation for better AI responses."
    ...
    def test_diagnosis_summary(self):
        ...
        working_components = [status for component, status in findings.items() if "Test Issues" not in component]
...
- Building a complete MCP chatbot client"""
            ...
            # Test the query
            response, sources = rag.query("What was covered in lesson 5 of the MCP course?")
            
            # Verify it worked as expected
            assert "Lesson 5 of the MCP course covered creating an MCP client" in response
            assert len(sources) == 1
            ...
            print("This confirms the RAG system handles course content queries correctly.")