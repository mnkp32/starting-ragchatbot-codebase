...
def assert_tool_called_correctly(
    mock_tool_manager, expected_tool_name, expected_params
):
    """Utility function to verify tool was called with correct parameters"""
    mock_tool_manager.execute_tool.assert_called_with(
        expected_tool_name, **expected_params
    )


def assert_search_results_formatted(
    result_text: str, expected_course: str, expected_lesson: int = None
):
